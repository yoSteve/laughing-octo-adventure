game.Tile = me.DraggableEntity.extend({
  ...
  moveHorizontal: function(right) {
    ...
    game.sendMessage('move', { pattern: 'row', row: this.row, movedRight: right, firstCrystal: game.playScreen.grid.grabbedCrystal.type });
    this.moved = true;
  },
  ...
  moveVertical: function(down) {
    ...
    game.sendMessage('move', { pattern: 'column', col: this.col, movedDown: down, firstCrystal: game.playScreen.grid.grabbedCrystal.type });
    this.moved = true;
  }
});
